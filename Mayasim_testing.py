...
temp = np.load(input_data_location + '0_RES_432x400_temp.npy') 
temp = temp/10. 
...
precip = np.load(input_data_location + '0_RES_432x400_precip.npy')    
 
# in meters above sea level                                                
elev = np.load(input_data_location + '0_RES_432x400_elev.npy')        
slope = np.load(input_data_location + '0_RES_432x400_slope.npy')
...
soilprod = np.load(input_data_location + '0_RES_432x400_soil.npy')
